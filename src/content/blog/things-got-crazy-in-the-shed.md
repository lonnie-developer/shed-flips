...
description: '21 eBay orders, one Mercari bundle, and two trash bags of $10-filler-bag yarn dumped on the floor — a full shipping-and-listing day in the shed.'
...
The **Steve Madden Kronos loafers** triggered the recurring Rev Resale joke. Rev (from [Rev Resale](https://www.youtube.com/@RevResale), the channel Lonnie watches) is allegedly a big-foot, and these are 9.5 D — Lonnie checked the buyer's name to make sure it wasn't him. It wasn't. We have four of these from Mr. A; one out, three to go.
...
- [Rev Resale](https://www.youtube.com/@RevResale) — Rev and Nikki T's reselling channel. We watch them; the size 9.5 D Steve Madden Kronos joke is at their expense (with affection).
- eBay business policies vs. the regular shipping flow — the missing live estimate is the gotcha. [eBay's policies docs](https://www.ebay.com/help/selling/business-policies) cover the setup.
...
- Pop Mart [*We Are Twinkle Twinkle Superman* pendant](https://www.popmart.com/) — Pop Mart's blind-box collectibles category has been a steady eBay seller for us in the $20-30 range.
